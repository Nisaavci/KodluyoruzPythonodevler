...
📚 İçerik / ödev 5
- Bir sözlük (dict) oluşturulur ve bu sözlükte öğrencilerin isimleri ile Matematik, Fizik, Kimya notları tutulur.
- Kullanıcıdan isim ve ders ismi (Matematik, Fizik, Kimya) istenir.
- Girilen bilgilere göre ilgili öğrencinin notu ekrana yazdırılır.
- Sözlük üzerinde:
- Değerleri değiştirme (örneğin öğrencinin notunu güncelleme)
- Yeni değer ekleme (yeni öğrenci veya yeni ders ekleme)
